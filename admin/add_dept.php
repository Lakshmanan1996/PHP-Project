	 ...
	 <div class="section-contact" id="contact">
	    <div class="container">
           <div class="contact-main">
					...
					<h3 class="tittle wow bounceIn"  data-wow-duration=".8s" data-wow-delay=".2s">Add New Department Detail</h3>
						...
						<?php
							...
							$qry=mysql_query("insert into department(dname)values('$dname')");
								if($qry)
								{
