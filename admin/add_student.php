	 ...
	 <div class="section-contact" id="contact">
	    <div class="container">
           <div class="contact-main">
					...
					<h3 class="tittle wow bounceIn"  data-wow-duration=".8s" data-wow-delay=".2s">Add New Student Detail</h3>
					...
					<div class="col-md-6 contact-in wow fadeInUp"  data-wow-duration="1s" data-wow-delay=".5s">
								<div class="styled-input" >
									  ...
									  <span></span> </div>
									<div class="styled-input">
									  <input type="text" required name="dept"/>
						...
						<?php
							...
							$move=move_uploaded_file($_FILES['photo']['tmp_name'],"student/".$fname);
							
							$cdate=date('d-m-Y');
							
							if($move)
							{
							$qry=mysql_query("insert into student_detail(cdate,name,cno,email,dept,address,photo)values('$cdate','$name','$cno','$email','$dept','$address','$fname')");
								if($qry)
								{
									$id=mysql_insert_id();
									$student_id="ST".$id;
									
									$update=mysql_query("update student_detail set stud_id='$student_id',pword='$student_id' where id='$id'");
									if($update){
