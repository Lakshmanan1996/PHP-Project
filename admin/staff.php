...
<div class="main-header" id="house">
	 ...
	 <div class="section-contact" id="contact">
	    <div class="container">
		<h3 class="tittle wow bounceIn"  data-wow-duration=".8s" data-wow-delay=".2s">Staff Details <a href="add_staff.php" style="float:right;text-transform:capitalize;float:right;font-size:18px;background:#ccc;padding:0px 15px;">Add Staff Detail</a></h3> 
           <div class="contact-main">
		   <?php
			$qry=mysql_query("select * from staff_detail");
				...
				<table class="table table-striped">
					...
					?>
					  <tr>
						...
						<td><img src="staff/<?php echo $row['photo']; ?>" width="73" height="100" /></td>
						...
						<td><a style="background:#FF002A;color:white;padding:3px;" href="delete_staff.php?id=<?php echo $row['id']; ?>"> Delete </a> </td>
					  </tr>
					 <?php
						}
					 ?>   
				   ...
				   <?php
					...
					{
						echo "<br/><br/>&nbsp;&nbsp;&nbsp;&nbsp; Sorry No Staffs List Found<br/><br/>";
					}			
				?>
			</div>	   
		</div>
