	 ...
	 <div class="section-contact" id="contact">
	    <div class="container">
           <div class="contact-main">
					...
					<h3 class="tittle wow bounceIn"  data-wow-duration=".8s" data-wow-delay=".2s">Add New Class Detail</h3>
						   ...
						   <form action="#" method="post" class="contact" enctype="multipart/form-data">
									...
									<div class="styled-input">
									  <input type="text" required name="class_section"/>
									  <label>Section</label>
									  <span></span> </div>
									
									<div class="styled-input">
									  <input type="text" required name="day_cat"/>
									  <label>Men/Women</label>
									  <span></span> </div>
									</div>
								<div class="col-md-6 contact-in wow fadeInUp"  data-wow-duration="1s" data-wow-delay=".5s">
									<br/><br/>
									<label style="font-weight:normal;padding-left:10px;">Year</label><br/>
									  <select required name="dname" style="margin-top:5px;width:100%;padding:7px;">
									...
									<label style="font-weight:normal;padding-left:10px;">Department</label><br/>
									  ...
									  <span></span> 
									<div class="styled-input">
									  <textarea required name="room_no"></textarea>
									  <label>Venue</label>
									  <span></span> </div>
										<div class="send">
						...
						<?php
							...
							$qry=mysql_query("insert into class_allot(dname,day_cat,class_cat,class_name,class_section,room_no)
							values('$dname','$day_cat','$class_cat','$class_name','$class_section','$room_no')");
