...
<div class="main-header" id="house">
	 ...
	 <div class="section-contact" id="contact">
	    <div class="container">
		<h3 class="tittle wow bounceIn"  data-wow-duration=".8s" data-wow-delay=".2s">Department Details <a href="add_dept.php" style="float:right;text-transform:capitalize;float:right;font-size:18px;background:#ccc;padding:0px 15px;">Add Department Detail</a></h3> 
				...
				<table class="table table-striped">
					...
					?>
					  <tr>
						...
						<td><a style="background:#FF002A;color:white;padding:3px;" href="delete_dept.php?id=<?php echo $row['did']; ?>"> Delete </a> </td>
					  </tr>
					 <?php
						}
					 ?>   
