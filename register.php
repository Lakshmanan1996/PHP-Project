	 ...
	 <div class="section-contact" id="contact">
	    <div class="container">
           <div class="contact-main">
					...
					<h3 class="tittle wow bounceIn"  data-wow-duration=".8s" data-wow-delay=".2s">Register Details</h3>
					...
					<div class="col-md-6 contact-in wow fadeInUp"  data-wow-duration="1s" data-wow-delay=".5s">
						<div class="styled-input" style="margin-top:25px;">
									  <input type="text" name="cno" required />
									  <label>Contact Number</label>
									  <span></span> </div>
									  
									<div class="styled-input">
									  <input type="text" name="dept" required name="name"/>
						...
						<?php
							...
							$qry=mysql_query("insert into register(cdate,name,cno,email,dept,address,uname,pword)values('$cdate','$name','$cno','$email','$dept','$address','$uname','$pword')");
								if($qry)
								{
